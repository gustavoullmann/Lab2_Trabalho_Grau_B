...
/**
 * Implementação de uma lista linear com armazenamento dinâmico,
 * baseado em nós singularmente encadeados (encadeamento somente em
 * um sentido).
 */
...
public class SinglyLinkedList<E> implements List<E> {
	...
	public void insert(E element, int pos) {
		// verifica se a posiçãoo é válida
